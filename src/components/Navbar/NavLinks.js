...
const NavLinks = () => {
    return (
      <div className="flex items-center">
        <Button title='About' variant='light' style={{textDecoration:'none', fontStyle:'normal'}}to="/about">
         About
        </Button>
        <DropdownButton id="services-dropdown" title="Services" variant='light' style={{padding:2}}>
          <Dropdown.Item href="/services">Action</Dropdown.Item>
          <Dropdown.Item href="/services">Another action</Dropdown.Item>
          <Dropdown.Item href="/services">Something else</Dropdown.Item>
        </DropdownButton>
        <DropdownButton id="capabillities-dropdown" variant='light' title="Capabilities" style={{padding:2, colorScheme: colors.haseBlue }}>
          ...
          <Dropdown.Item href="/capabilities">Tubing</Dropdown.Item>
