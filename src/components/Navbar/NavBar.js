    ...
    return (
        <nav className={`fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-20 ${!top && 'bg-white shadow-lg'}`}>
            <div className="flex flex-row justify-between items-center">
                <Link to="/">
                    <div className="flex items-center" width={1/2} style={{paddingTop: 2 , paddingBottom: 4}}>
                    <img alt="card img" className="rounded-t duration-1000" style={{maxWidth:'50%'}} src={haseLogoImg} />
                    <img alt="card img" className="rounded-t duration-1000" style={{maxWidth:'50%'}} src={grandRiverLogoImg} />
                    </div>
                </Link>
                <div className="group flex flex-col items-center">
                    <button className="p-2 rounded-lg lg:hidden" style={{ backgroundColor: colors.haseBlue }} onClick={handleClick}>
